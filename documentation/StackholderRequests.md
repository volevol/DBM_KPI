...
| Основний сценарій: | 1.Адмін натискає кнопку [Видалити обраний проект]<br>
2.Система виводить вікно підтвердження видалення.<br>3.Адмін погоджується.<br>4.Система видаляє певний проект.<br>5.Система виводить сповіщення власнику проекта, що він видалений. |

**Сценарій dизначення/зміни методології**
...
| Основний сценарій: | 1.Автор в налаштуваннях натискає кнопку [Визначити методологію]<br>
2.Система виводить вікно з вибором методологій.<br>3.Автор вибирає потрібну йому методологію.<br>4.Система виставляє вибрану методологію на проект. |
...
| Основний сценарій: | 1.Автор в меню проекта натискає  кнопку [Додати задачу].<br>
2.Система виводить вікно створення задачі.<br>3.Автор вводить всі потрібні дані.<br>4.Система створює нову задачу. |
| Виключні ситуації: |  Відсутність активного проекта |
...
![](https://imgur.com/OfJdA2t)

**Діаграма AU-SET-METH**

![](https://imgur.com/Jl5Bs4y)
