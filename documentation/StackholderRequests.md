...
| Виключні ситуації: |   |
| Основний сценарій: | 1. Користувач натискає кнопку [View Projects]<br>2. Система показує список наявних проектів |
...
**Сценарій запиту на commit**

| Ідентифікатор: | CommReq |
| --- | --- |
| Назва: | Запит на commit |
...
| Основний сценарій: | 1. Користувач натискає кнопку [Commit Request]<br>2. Система надсилає запит Автору на додання нового contributor |
...
| Ідентифікатор: | ADM-DL-PR |
| --- | --- |
| Назва: | Видалення проекту адміном |
| Участники: | Користувач; Система; Адмін; |
...
| Основний сценарій: | 1.Адмін натискає кнопку [Видалити обраний проект]<br>2.Система виводить вікно підтвердження видалення.<br>3.Адмін погоджується.<br>4.Система видаляє певний проект.<br>5.Система виводить сповіщення власнику проекта, що він видалений. |

**Сценарій визначення/зміни методології**

| Ідентифікатор: | AU-SET-METH |
| --- | --- |
...
| Основний сценарій: | 1.Автор в налаштуваннях натискає кнопку [Визначити методологію]<br>2.Система виводить вікно з вибором методологій.<br>3.Автор вибирає потрібну йому методологію.<br>4.Система виставляє вибрану методологію на проект. |
...
| Основний сценарій: | 1.Автор в меню проекта натискає  кнопку [Додати задачу].<br>2.Система виводить вікно створення задачі.<br>3.Автор вводить всі потрібні дані.<br>4.Система створює нову задачу. |
| Виключні ситуації: |  Відсутність активного проекта |
...
![](http://www.plantuml.com/plantuml/png/TOynKiD034Lxd-9FUYwGWiaCK51H6EZbjJnUs9M2f8N9xO6CmOMJHetqtjS_U915gwLBAc5Qq9yyk7QKGWqlpjRz3jpSBXliyKn7x5upVo7Bf5OfiWfeq1Ouchvn2jzXQ14gtKBzy6VF7lsibq3wf5neAFolk1BSCrcQh_kVfeaDVhv2iDMjvq623IC5BU72YTt9Jd_XgtQbxcPExuv93PKYpUp8WdiA6iXv-yZZfgFnHyl6urhnm3AsMhu1)
